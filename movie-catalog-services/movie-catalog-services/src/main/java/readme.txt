...
STOREPROC and DIRECT QUERY can be provided in the REPO interface itself since they dont need to be implemented whereas
	Complicated Query declared in CustomerQuery should be implemented by the implementation class
